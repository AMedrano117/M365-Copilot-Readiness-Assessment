    ...
    if entra_insights and status == "Success":
        ...
        if total_policies == 0:
            observations.append(new_recommendation(
                ...
                priority="High",
                status=status,
                evidence_key="conditional_access_detail",
                evidence_summary="See Conditional Access Detail for the exact policies, controls, and targeting scope reviewed for this finding."
            ))
        ...
        # Policies exist but no MFA enforcement
            ...
            observations.append(new_recommendation(
                ...
                status=status,
                evidence_key="conditional_access_detail",
                evidence_summary="See Conditional Access Detail for the exact policies reviewed, including whether MFA, device controls, and Microsoft 365 targeting are present."
            ))
    ...
    if entra_insights and status == "Success":
        ...
        if total_policies > 0 and target_m365 == 0:
            observations.append(new_recommendation(
                ...
                status=status,
                evidence_key="conditional_access_detail",
                evidence_summary="See Conditional Access Detail for the current policy inventory and targeting details so engineering can identify which policies need scope changes."
            ))
