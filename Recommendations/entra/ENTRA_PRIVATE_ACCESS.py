    ...
    if entra_insights:
        ...
        if private_status == 'NotLicensed':
            ...
            observations.append(new_recommendation(
                ...
                recommendation="In this target tenant, add Microsoft Graph application permission NetworkAccessPolicy.Read.All to the app registration identified by CLIENT_ID and grant tenant-wide admin consent. Consent from another tenant does not apply. Then wait for propagation and rerun the assessment to verify Internet and Private Access policy visibility.",
