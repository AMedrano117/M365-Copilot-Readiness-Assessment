    ...
    if entra_insights and status == "Success":
        ...
        if permanent_admin_roles > 0:
            observations.append(new_recommendation(
                ...
                evidence_summary="See Admin Role Detail for the standing and eligible privileged assignments supporting this governance finding."
            ))
    ...
    if entra_insights and status == "Success":
        ...
        if total_reviews == 0:
            observations.append(new_recommendation(
                ...
                evidence_summary="See Access Review Detail for the current review definitions, cadence, and scope coverage available for engineer follow-up."
            ))
    ...
    if entra_insights and status == "Success":
        ...
        if high_privilege_apps > 0 or unverified_publishers > 0:
            ...
            observations.append(new_recommendation(
                ...
                status=status,
                evidence_key="app_access_detail",
                evidence_summary="See App Access Detail for the flagged applications, exact granted scopes, why each app was counted, and any available 30-day activity."
            ))
        else:
